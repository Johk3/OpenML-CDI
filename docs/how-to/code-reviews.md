...
2. **Review your own code first:** Read through your "Files Changed" tab on GitHub *before* requesting a review. Catch your own typos and leftover `console.log()` statements.
3. **Provide context:** Fill out the PR template completely. If you made a weird architectural decision because of a library limitation, leave an inline comment on your own PR explaining *why*.
...
Before looking at the code, read the PR description and the linked issue . What is this code *supposed* to do? 
